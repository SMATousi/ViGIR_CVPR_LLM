...
model = CLIPModel.from_pretrained("openai/clip-vit-large-patch14-336", device_map=device)
processor = CLIPProcessor.from_pretrained("openai/clip-vit-large-patch14-336")

dataset_dir = "/home1/pupil/goowfd/CVPR_2025/hateful_memes/img/"

output_file = "/home1/pupil/goowfd/CVPR_2025/hateful_memes/CLIP_predictions_hateful_l14-dev.json"

text_inputs = ["a photo of a hateful meme", "a photo of a non hateful meme"]
#text_inputs = ["This meme promotes hate.", "This meme contains offensive content.", "This is a hateful meme.", "This meme is funny and harmless.", "This meme is not offensive.", "This is a positive meme."]
...
for i, entry in enumerate(image_data):
    ...
    if os.path.exists(img_path):
        ...
        #mean_hateful = probs[:, :3].mean()
        #mean_non_hateful = probs[:, 3:].mean()

        # Average score of the hateful prompts is greater than non-hateful then we predict label as hateful
        #if (mean_hateful.item() > mean_non_hateful.item()):
         #   predicted_label = 1 # hateful
        #else :
